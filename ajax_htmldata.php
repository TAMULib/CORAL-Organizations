...
?>
		...
		<table id="downTimeTable" class='linedFormTable issueTabTable'>
			...
			<tr>
				<td><a id="createDowntimeBtn" class="thickbox" href="ajax_forms.php?action=getNewDowntimeForm&organizationID=<?php echo $_GET['organizationID']; ?>&height=260&width=390&modal=true">report new Downtime</a></td>
			</tr>
			<tr>
				<td>
